...
the `github.com/FairlySadPanda/open-match-but-kube-got-shreked/internal/testing/e2e` import.
...
import (
	"github.com/FairlySadPanda/open-match-but-kube-got-shreked/internal/testing/e2e"
	"testing"
)
